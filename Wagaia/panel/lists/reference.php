	...
	<?php
		...
		$sql = "SELECT b.titre, b.intro, a.id, a.date, b.sous_titre, b.texte, a.id, a.icon FROM wagaia_pages a 
					...
					WHERE a.parent = '".$parent."' AND b.lg = 'fr' AND a.type = 'reference' ORDER BY position";
		$data = $db->select($sql);
			...
			<tr>
				...
				<td class="nowrap" width="200">
					<div class="action-buttons">
                        ...
                        <a title="Sous blocs" data-toggle="tooltip" rel="tooltip" href="pages.php?show=list&parent=<?=$v->id?>&type=sousref" class="btn btn-xs btn-success"><i class="fa fa-th-large bigger-120"></i></a>
