...
(function($ , undefined) {
	$.fn.ace_wysiwyg = function($options , undefined) {
		...
		var button_defaults =
		{
			...
			'insertChp1' : {
				values:['{EVENEMENTSType}', '{EVENEMENTSAdresse_Lieu_1}', '{EVENEMENTSville}', '{EVENEMENTSpays}', '{EVENEMENTSacces}', '{EVENEMENTSDate_Debut}', '{EVENEMENTSDate_Fin}', '{EVENEMENTSIntitule_1}', '{EVENEMENTSLieu_1}', '{EVENEMENTSTitre}', '{EVENEMENTSTxt_Fact}', '{EVENEMENTSsiteducongres}', '{EVENEMENTSClient}', '{EVENEMENTSprenomrespinscription}', '{EVENEMENTSnomrespinscription}', '{EVENEMENTSemailrespinscription}', '{EVENEMENTStelrespinscription}', '{EVENEMENTSurl}', '{EVENEMENTSlogo}'],
				icon : 'icon-bookmark',
				title : 'Personnalisation Ev&egrave;nement'
			},
			'insertChp2' : {
				values:['{GROUPESNom_Groupe}', '{GROUPESNom_Responsable}', '{GROUPESPrenom_Responsable}', '{GROUPESSoldeH}', '{GROUPESSoldeI}'],
				icon : 'icon-group',
				title : 'Personnalisation Groupe'
			},
			'insertChp3' : {
				values:['{PARTICIPANTSdatedenaissance}', '{PARTICIPANTSdatedevaliditepasseport}', '{PARTICIPANTSlieudenaissance}', '{PARTICIPANTSndepasseport}', '{PARTICIPANTSAdresse_1}', '{PARTICIPANTSAdresse_2}', '{PARTICIPANTSAdresse_3}', '{PARTICIPANTSCode_Postal}', '{PARTICIPANTSEmail}', '{PARTICIPANTSFax}', '{PARTICIPANTSFonction}', '{PARTICIPANTSNom}', '{PARTICIPANTSParticipation}', '{PARTICIPANTSPays}', '{PARTICIPANTSPortable}', '{PARTICIPANTSPrenom}', '{PARTICIPANTSSociete}', '{PARTICIPANTSSoldeH}', '{PARTICIPANTSSoldeI}', '{PARTICIPANTSInterventions}', '{PARTICIPANTSHebergement}', '{PARTICIPANTSPrestations}', '{PARTICIPANTSTelephone}', '{PARTICIPANTSTitre}', '{PARTICIPANTSVille}', '{PARTICIPANTSUrlConnect}'],
				icon : 'icon-user',
				title : 'Personnalisation Participant'
			},
			'insertChp4' : {
				values:['{Util_Prenom}', '{Util_Nom}', '{Util_email}', '{Util_lignedirecte}', '{Util_mobile}', '{Util_adressepostale}'],
				icon : 'icon-bullseye',
				title : 'Personnalisation Responsable'
			},
			'insertChp5' : {
				values:['{PRESTATIONintitule}', '{PRESTATIONadresse}', '{PRESTATIONdate}', '{PRESTATIONheure}', '{PRESTATIONcommentaire}'],
				icon : 'icon-coffee',
				title : 'Personnalisation Prestation'
			},
			'foreColor' : {
				values : color_values,
				title : 'Change Color'
		...
		this.each(function() {
			...
			for(var tb in toolbar_buttons) if(toolbar_buttons.hasOwnProperty(tb)) {
				...
				switch(button.name) {
					...
					case 'insertChp1':
						toolbar += ' <div class="inline position-relative"><a class="btn btn-sm '+className+' dropdown-toggle" data-toggle="dropdown" title="'+button.title+'"><i class="'+button.icon+'"></i><i class="icon-angle-down icon-on-right"></i></a> ';
						toolbar += ' <ul class="dropdown-menu dropdown-light">';
						for(var insertChp1 in button.values)
							if(button.values.hasOwnProperty(insertChp1))
								toolbar += ' <li><a data-edit="inserttext '+ button.values[insertChp1] +'">'+ button.values[insertChp1] +'</a></li> '
						toolbar += ' </ul></div>';
					break;
					case 'insertChp2':
						toolbar += ' <div class="inline position-relative"><a class="btn btn-sm '+className+' dropdown-toggle" data-toggle="dropdown" title="'+button.title+'"><i class="'+button.icon+'"></i><i class="icon-angle-down icon-on-right"></i></a> ';
						toolbar += ' <ul class="dropdown-menu dropdown-light">';
						for(var insertChp2 in button.values)
							if(button.values.hasOwnProperty(insertChp2))
								toolbar += ' <li><a data-edit="inserttext '+ button.values[insertChp2] +'">'+ button.values[insertChp2] +'</a></li> '
						toolbar += ' </ul></div>';
					break;
					case 'insertChp3':
						toolbar += ' <div class="inline position-relative"><a class="btn btn-sm '+className+' dropdown-toggle" data-toggle="dropdown" title="'+button.title+'"><i class="'+button.icon+'"></i><i class="icon-angle-down icon-on-right"></i></a> ';
						toolbar += ' <ul class="dropdown-menu dropdown-light">';
						for(var insertChp3 in button.values)
							if(button.values.hasOwnProperty(insertChp3))
								toolbar += ' <li><a data-edit="inserttext '+ button.values[insertChp3] +'">'+ button.values[insertChp3] +'</a></li> '
						toolbar += ' </ul></div>';
					break;
					case 'insertChp4':
						toolbar += ' <div class="inline position-relative"><a class="btn btn-sm '+className+' dropdown-toggle" data-toggle="dropdown" title="'+button.title+'"><i class="'+button.icon+'"></i><i class="icon-angle-down icon-on-right"></i></a> ';
						toolbar += ' <ul class="dropdown-menu dropdown-light">';
						for(var insertChp4 in button.values)
							if(button.values.hasOwnProperty(insertChp4))
								toolbar += ' <li><a data-edit="inserttext '+ button.values[insertChp4] +'">'+ button.values[insertChp4] +'</a></li> '
						toolbar += ' </ul></div>';
					break;
					case 'insertChp5':
						toolbar += ' <div class="inline position-relative"><a class="btn btn-sm '+className+' dropdown-toggle" data-toggle="dropdown" title="'+button.title+'"><i class="'+button.icon+'"></i><i class="icon-angle-down icon-on-right"></i></a> ';
						toolbar += ' <ul class="dropdown-menu dropdown-light">';
						for(var insertChp5 in button.values)
							if(button.values.hasOwnProperty(insertChp5))
								toolbar += ' <li><a data-edit="inserttext '+ button.values[insertChp5] +'">'+ button.values[insertChp5] +'</a></li> '
						toolbar += ' </ul></div>';
					break;
