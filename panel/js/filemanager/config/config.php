...
//include ( '../../../config/config-wagaia.php' );
//------------------------------------------------------------------------------
...
$upload_dir = '/upload/filemanager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../upload/filemanager/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../upload/filemanager/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
